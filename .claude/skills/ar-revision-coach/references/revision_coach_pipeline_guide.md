# Panduan Alur Kerja Pipeline `ar-revision-coach` (Fase 19–21)

Dokumen ini merupakan panduan operasional mendalam untuk skill `ar-revision-coach`, yang bertugas mendekonstruksi komentar reviewer mentah menjadi rencana aksi terstruktur sebelum naskah diubah.
...
```mermaid
flowchart LR
    F18[Fase 18: Penerimaan Hasil Review<br/>Keputusan Editorial & Komentar] --> F19[Fase 19: Revision Analysis<br/><b>ar-revision-coach</b>: Dekonstruksi & Prioritisasi]
...
> [!IMPORTANT]
> **Batasan Peran**: `ar-revision-coach` **TIDAK MENGUBAH TEKS NASKAH**. Tujuannya adalah menghasilkan lembar kerja dan strategi matang yang dibawa ke meja dosen pembimbing (Fase 21) sebelum peneliti menjalankan eksperimen tambahan atau mengetik revisi di Fase 22.
