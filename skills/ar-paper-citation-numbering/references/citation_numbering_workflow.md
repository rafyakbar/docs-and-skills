...
Step 2: ar-paper-sentence-citation     -> Kurasi sitasi per kalimat -> paper/references.txt & paper/references/*.bib
Step 3: ar-paper-reference-compiler    -> Kompilasi daftar pustaka -> paper/06_references.md
Step 4: ar-paper-citation-numbering    -> Injeksi tautan braket [[N]](06_references.md#refN) ke draf bab
