...
> [!NOTE]
> **Fokus Khusus Step 3**
> Skill ini hanya menyusun berkas naskah daftar pustaka `paper/06_references.md`. Skill ini **TIDAK mengubah teks draf bab atau menyisipkan nomor sitasi braket pada bab** (tugas tersebut dikerjakan pada Step 4 oleh `ar-citation-numbering`) dan **TIDAK mencari literatur baru** (dikerjakan pada Step 2 oleh `ar-sentence-citation`).
...
- Mengganti teks draf menjadi nomor sitasi braket dan tautan markdown `[[N]](06_references.md#refN)` (gunakan `ar-citation-numbering` / Step 4).
