...
- Menyusun atau mengompilasi naskah daftar pustaka akhir `06_references.md` (gunakan `ar-paper-reference-compiler` / Step 3).
- Memberikan penomoran angka sitasi dan penautan tautan markdown `[[1]]` pada teks bab (gunakan `ar-paper-citation-numbering` / Step 4).
