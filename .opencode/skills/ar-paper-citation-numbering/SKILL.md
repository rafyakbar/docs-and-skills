...
> [!NOTE]
> **Fokus Khusus Step 4**
> Skill ini hanya menyisipkan nomor sitasi braket ke dalam teks draf naskah bab. Skill ini **TIDAK mengubah makna atau menulis ulang teks narasi draf** (ditulis pada Step 1 oleh `ar-paper-draft`), **TIDAK mencari literatur rujukan baru** (dikerjakan pada Step 2 oleh `ar-paper-sentence-citation`), dan **TIDAK menyusun berkas daftar pustaka** (dikerjakan pada Step 3 oleh `ar-paper-reference-compiler`).
...
- Mengompilasi naskah daftar pustaka akhir `paper/06_references.md` dari berkas bibliografi (gunakan `ar-paper-reference-compiler` / Step 3).
