...
## [](#onpremcertificates)onprem.certificates
...
## [](#onpremcompute)onprem.compute

**diagrams.onprem.compute.Nomad**

**diagrams.onprem.compute.Server**

## [](#onpremcontainer)onprem.container
...
## [](#onpremdatabase)onprem.database
...
## [](#onpremgroupware)onprem.groupware

**diagrams.onprem.groupware.Nextcloud**

## [](#onpremiac)onprem.iac
...
## [](#onpremidentity)onprem.identity

**diagrams.onprem.identity.Dex**

## [](#onpreminmemory)onprem.inmemory
...
## [](#onpremproxmox)onprem.proxmox

**diagrams.onprem.proxmox.Pve**, **ProxmoxVE** (alias)

## [](#onpremqueue)onprem.queue
...
## [](#onpremworkflow)onprem.workflow
