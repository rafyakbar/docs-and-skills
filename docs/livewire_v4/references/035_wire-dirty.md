...
## Using the `$dirty` expression[¶](#using-the-dirty-expression "")
...
### Check if entire component is dirty[¶](#check-if-entire-component-is-dirty "")
...
### Check if a specific property is dirty[¶](#check-if-a-specific-property-is-dirty "")
...
### Conditional logic based on dirty state[¶](#conditional-logic-based-on-dirty-state "")
...
### `$dirty` expression[¶](#dirty-expression "")
