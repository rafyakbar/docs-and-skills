## Using JavaScript in Livewire components[¶](#using-javascript-in-livewire-components "")
...
### Using `$wire` from scripts[¶](#using-wire-from-scripts "")
...
## The `$wire` object[¶](#the-wire-object "")
...
## The `Livewire` global object[¶](#the-livewire-global-object "")
...
### Registering custom directives[¶](#registering-custom-directives "")
...
### DOM element initialization[¶](#dom-element-initialization "")
...
### DOM Morph hooks[¶](#dom-morph-hooks "")
...
## Server-side JavaScript evaluation[¶](#server-side-javascript-evaluation "")
...
### Syncing with localStorage[¶](#syncing-with-localstorage "")
...
### Using the `@js` directive[¶](#using-the-js-directive "")
...
### Component scripts vs global scripts[¶](#component-scripts-vs-global-scripts "")
...
### The `$wire` object[¶](#the-wire-object-1 "")
...
### The `snapshot` object[¶](#the-snapshot-object "")
