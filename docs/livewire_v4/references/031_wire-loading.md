...
## Targeting specific actions[¶](#targeting-specific-actions "")
...
### Targeting multiple actions[¶](#targeting-multiple-actions "")
...
### Targeting action parameters[¶](#targeting-action-parameters "")
...
### Targeting property updates[¶](#targeting-property-updates "")
...
### Excluding specific loading targets[¶](#excluding-specific-loading-targets "")
...
## Customizing CSS display property[¶](#customizing-css-display-property "")
...
## Delaying a loading indicator[¶](#delaying-a-loading-indicator "")
...
## Styling with data-loading[¶](#styling-with-data-loading "")
...
### Using Tailwind's data attribute variant[¶](#using-tailwinds-data-attribute-variant "")
...
### Styling parent and child elements[¶](#styling-parent-and-child-elements "")
