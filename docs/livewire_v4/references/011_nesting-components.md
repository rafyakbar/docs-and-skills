...
## Nesting a component[¶](#nesting-a-component "")
...
## Passing props to children[¶](#passing-props-to-children "")
...
### Passing static props[¶](#passing-static-props "")
...
### Shortened attribute syntax[¶](#shortened-attribute-syntax "")
...
## Rendering children in a loop[¶](#rendering-children-in-a-loop "")
...
## Binding to child data using `wire:model`[¶](#binding-to-child-data-using-wiremodel "")
...
### Checking if a slot was provided[¶](#checking-if-a-slot-was-provided "")
...
## Forwarding HTML attributes[¶](#forwarding-html-attributes "")
...
## Islands vs nested components[¶](#islands-vs-nested-components "")
...
### When to use nested components[¶](#when-to-use-nested-components "")
...
## Listening for events from children[¶](#listening-for-events-from-children "")
...
### Improving performance by dispatching client-side[¶](#improving-performance-by-dispatching-client-side "")
...
## Directly accessing the parent from the child[¶](#directly-accessing-the-parent-from-the-child "")
...
## Dynamic child components[¶](#dynamic-child-components "")
...
## Forcing a child component to re-render[¶](#forcing-a-child-component-to-re-render "")
