...
## Setting up Livewire and Alpine locally[¶](#setting-up-livewire-and-alpine-locally "")
...
### Forking and cloning the repositories[¶](#forking-and-cloning-the-repositories "")
...
#### 1. Determine where to add your test[¶](#1-determine-where-to-add-your-test "")
...
#### 2. Determine the type of test[¶](#2-determine-the-type-of-test "")
...
#### 4. Preparing your pull request branch[¶](#4-preparing-your-pull-request-branch "")
...
#### 5. Submitting your pull request[¶](#5-submitting-your-pull-request "")
