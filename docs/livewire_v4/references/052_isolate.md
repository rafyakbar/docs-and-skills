...
## Why bundling matters[¶](#why-bundling-matters "")
...
## Example: Polling components[¶](#example-polling-components "")
...
## Lazy components are isolated by default[¶](#lazy-components-are-isolated-by-default "")
