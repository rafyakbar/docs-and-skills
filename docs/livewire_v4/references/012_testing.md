...
## Configuring Pest for view-based components[¶](#configuring-pest-for-view-based-components "")
...
### Testing a page contains a component[¶](#testing-a-page-contains-a-component "")
...
### Installing browser testing[¶](#installing-browser-testing "")
...
### Asserting view data[¶](#asserting-view-data "")
...
### Testing JS evaluation[¶](#testing-js-evaluation "")
...
## All available testing methods[¶](#all-available-testing-methods "")
...
### Interacting with components[¶](#interacting-with-components "")
