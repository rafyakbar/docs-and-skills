...
## Rendering placeholder HTML[¶](#rendering-placeholder-html "")
...
### Using the @placeholder directive[¶](#using-the-placeholder-directive "")
...
### Using the placeholder() method[¶](#using-the-placeholder-method "")
...
## Loading immediately after page load[¶](#loading-immediately-after-page-load "")
...
## Passing in props[¶](#passing-in-props "")
...
## Enforcing lazy or defer by default[¶](#enforcing-lazy-or-defer-by-default "")
...
### Using the bundle parameter[¶](#using-the-bundle-parameter "")
...
### Using the bundle modifier[¶](#using-the-bundle-modifier "")
...
### When to use bundling[¶](#when-to-use-bundling "")
...
### Lazy loading full pages[¶](#lazy-loading-full-pages "")
...
### Deferring full pages[¶](#deferring-full-pages "")
...
### Disabling lazy/defer loading[¶](#disabling-lazydefer-loading "")
...
## Disabling lazy loading for tests[¶](#disabling-lazy-loading-for-tests "")
