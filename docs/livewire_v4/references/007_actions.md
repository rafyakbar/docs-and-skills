...
### Event handler modifiers[¶](#event-handler-modifiers "")
...
### Handling third-party events[¶](#handling-third-party-events "")
...
### Listening for dispatched custom events[¶](#listening-for-dispatched-custom-events "")
...
### Disabling inputs while a form is being submitted[¶](#disabling-inputs-while-a-form-is-being-submitted "")
...
## Confirming an action[¶](#confirming-an-action "")
...
## Calling actions from Alpine[¶](#calling-actions-from-alpine "")
...
### Passing parameters[¶](#passing-parameters-1 "")
...
### Receiving return values[¶](#receiving-return-values "")
...
### Calling from Alpine[¶](#calling-from-alpine "")
...
### Calling from PHP[¶](#calling-from-php "")
...
### Using magic actions from Alpine[¶](#using-magic-actions-from-alpine "")
...
## Skipping re-renders[¶](#skipping-re-renders "")
...
## Parallel execution with async[¶](#parallel-execution-with-async "")
...
### Using the Async attribute[¶](#using-the-async-attribute "")
...
### When to use async actions[¶](#when-to-use-async-actions "")
...
### When NOT to use async actions[¶](#when-not-to-use-async-actions "")
...
### Fetching data for JavaScript[¶](#fetching-data-for-javascript "")
...
### Always authorize action parameters[¶](#always-authorize-action-parameters "")
...
### Always authorize server-side[¶](#always-authorize-server-side "")
...
### Keep dangerous methods protected or private[¶](#keep-dangerous-methods-protected-or-private "")
