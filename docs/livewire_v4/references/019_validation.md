...
### Opting out of localization[¶](#opting-out-of-localization "")
...
## Defining a `rules()` method[¶](#defining-a-rules-method "")
...
## Using Laravel Rule objects[¶](#using-laravel-rule-objects "")
...
## Manually controlling validation errors[¶](#manually-controlling-validation-errors "")
...
## Accessing the validator instance[¶](#accessing-the-validator-instance "")
...
## Accessing errors in JavaScript[¶](#accessing-errors-in-javascript "")
...
## Deprecated `[#Rule]` attribute[¶](#deprecated-rule-attribute "")
