...
## Disabling URL query string tracking[¶](#disabling-url-query-string-tracking "")
...
## Customizing scroll behavior[¶](#customizing-scroll-behavior "")
...
## Resetting the page[¶](#resetting-the-page "")
...
### Available page navigation methods[¶](#available-page-navigation-methods "")
...
## Hooking into page updates[¶](#hooking-into-page-updates "")
...
### Named paginator hooks[¶](#named-paginator-hooks "")
...
### General paginator hooks[¶](#general-paginator-hooks "")
...
## Using Bootstrap instead of Tailwind[¶](#using-bootstrap-instead-of-tailwind "")
...
## Modifying the default pagination views[¶](#modifying-the-default-pagination-views "")
...
## Using custom pagination views[¶](#using-custom-pagination-views "")
...
### Via `paginationView()` or `paginationSimpleView()`[¶](#via-paginationview-or-paginationsimpleview "")
...
### Sample pagination view[¶](#sample-pagination-view "")
