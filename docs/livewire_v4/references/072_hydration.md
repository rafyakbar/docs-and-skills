...
### Embedding the snapshot in the HTML[¶](#embedding-the-snapshot-in-the-html "")
...
### Deeply nested tuples[¶](#deeply-nested-tuples "")
...
### Supporting custom property types[¶](#supporting-custom-property-types "")
