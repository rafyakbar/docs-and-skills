...
## Create a layout file[¶](#create-a-layout-file "")
...
## Customizing Livewire's update endpoint[¶](#customizing-livewires-update-endpoint "")
...
## Customizing the JavaScript asset URL[¶](#customizing-the-javascript-asset-url "")
...
## Publishing Livewire's assets to public directory[¶](#publishing-livewires-assets-to-public-directory "")
...
## Disabling automatic asset injection[¶](#disabling-automatic-asset-injection "")
...
## Livewire JavaScript not loading (404 error)[¶](#livewire-javascript-not-loading-404-error "")
...
## Alpine.js not available on pages without Livewire components[¶](#alpinejs-not-available-on-pages-without-livewire-components "")
...
## Components not updating or errors in browser console[¶](#components-not-updating-or-errors-in-browser-console "")
