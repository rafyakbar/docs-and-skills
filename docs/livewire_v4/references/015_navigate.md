...
## Persisting elements across page visits[¶](#persisting-elements-across-page-visits "")
...
### Highlighting active links[¶](#highlighting-active-links "")
...
#### Using the `data-current` attribute[¶](#using-the-data-current-attribute "")
...
#### Using the `wire:current` directive[¶](#using-the-wirecurrent-directive "")
...
## Manually visiting a new page[¶](#manually-visiting-a-new-page "")
...
## Using with analytics software[¶](#using-with-analytics-software "")
...
### Don't rely on `DOMContentLoaded`[¶](#dont-rely-on-domcontentloaded "")
...
### Scripts in `<head>` are loaded once[¶](#scripts-in-head-are-loaded-once "")
...
### New `<head>` scripts are evaluated[¶](#new-head-scripts-are-evaluated "")
...
### Scripts in the `<body>` are re-evaluated[¶](#scripts-in-the-body-are-re-evaluated "")
