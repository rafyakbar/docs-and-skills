...
## What is Content Security Policy (CSP)?[¶](#what-is-content-security-policy-csp "")
...
### Why CSP Affects Livewire[¶](#why-csp-affects-livewire "")
...
## Enabling CSP-Safe Mode[¶](#enabling-csp-safe-mode "")
...
## Impact on Alpine.js[¶](#impact-on-alpinejs "")
...
### Basic Livewire Expressions[¶](#basic-livewire-expressions "")
...
### Method Calls with Parameters[¶](#method-calls-with-parameters "")
...
### Property Access and Updates[¶](#property-access-and-updates "")
...
### Basic Expressions in Alpine[¶](#basic-expressions-in-alpine "")
...
### Complex JavaScript Expressions[¶](#complex-javascript-expressions "")
...
### Template Literals and Advanced Syntax[¶](#template-literals-and-advanced-syntax "")
...
## Working around limitations[¶](#working-around-limitations "")
...
## CSP Headers Example[¶](#csp-headers-example "")
...
## When to Use CSP-Safe Mode[¶](#when-to-use-csp-safe-mode "")
