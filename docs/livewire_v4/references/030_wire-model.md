...
## Customizing update timing[¶](#customizing-update-timing "")
...
#### Customizing the debounce[¶](#customizing-the-debounce "")
...
### Updating on "blur" event[¶](#updating-on-blur-event "")
...
### Updating on "change" event[¶](#updating-on-change-event "")
...
### Updating on "enter" key[¶](#updating-on-enter-key "")
...
### Dependent select dropdowns[¶](#dependent-select-dropdowns "")
...
### Listening to child events[¶](#listening-to-child-events "")
...
## Skipping renders[¶](#skipping-renders "")
