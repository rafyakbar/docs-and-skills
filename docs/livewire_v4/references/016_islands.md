...
### Lazy vs Deferred loading[¶](#lazy-vs-deferred-loading "")
...
## Append and prepend modes[¶](#append-and-prepend-modes "")
...
## Triggering islands from JavaScript[¶](#triggering-islands-from-javascript "")
