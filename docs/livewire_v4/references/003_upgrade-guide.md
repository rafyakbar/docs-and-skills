...
## Upgrading to v4.1 from v4.0[¶](#upgrading-to-v41-from-v40 "")

### `wire:model` modifier behavior change[¶](#wiremodel-modifier-behavior-change "")
...
#### Renamed configuration keys[¶](#renamed-configuration-keys "")
...
### `wire:model` now ignores child events by default[¶](#wiremodel-now-ignores-child-events-by-default "")
...
### Use `wire:navigate:scroll`[¶](#use-wirenavigatescroll "")
...
### Component tags must be closed[¶](#component-tags-must-be-closed "")
...
### `wire:model` modifiers now control client-side sync timing[¶](#wiremodel-modifiers-now-control-client-side-sync-timing "")
...
### `wire:transition` now uses View Transitions API[¶](#wiretransition-now-uses-view-transitions-api "")
...
### Update hooks consolidate array/object changes[¶](#update-hooks-consolidate-arrayobject-changes "")
...
### `wire:model` now supports bracket notation[¶](#wiremodel-now-supports-bracket-notation "")
...
### Livewire Asset and Endpoint URL Changes[¶](#livewire-asset-and-endpoint-url-changes "")
...
### JavaScript deprecations[¶](#javascript-deprecations "")

#### Deprecated: `$wire.$js()` method[¶](#deprecated-wirejs-method "")
...
#### Deprecated: `$js` without prefix[¶](#deprecated-js-without-prefix "")
...
#### Deprecated: `commit` and `request` hooks[¶](#deprecated-commit-and-request-hooks "")
...
#### Migrating from `commit` hook[¶](#migrating-from-commit-hook "")
...
#### Migrating from `request` hook[¶](#migrating-from-request-hook "")
...
### Update component imports[¶](#update-component-imports "")
...
### Update route definitions[¶](#update-route-definitions "")
...
### Update test files[¶](#update-test-files "")
...
### Remove Volt service provider[¶](#remove-volt-service-provider "")
...
### Remove Volt package[¶](#remove-volt-package "")
...
### Install Livewire v4[¶](#install-livewire-v4 "")
...
### Loading improvements[¶](#loading-improvements "")
...
### New directives and modifiers[¶](#new-directives-and-modifiers "")
