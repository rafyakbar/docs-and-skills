...
### Listening for dynamic event names[¶](#listening-for-dynamic-event-names "")
...
## Using JavaScript to interact with events[¶](#using-javascript-to-interact-with-events "")
...
### Listening for events inside component scripts[¶](#listening-for-events-inside-component-scripts "")
...
### Dispatching events from component scripts[¶](#dispatching-events-from-component-scripts "")
...
### Listening for Livewire events from global JavaScript[¶](#listening-for-livewire-events-from-global-javascript "")
...
## Events in Alpine[¶](#events-in-alpine "")
...
### Listening for Livewire events in Alpine[¶](#listening-for-livewire-events-in-alpine "")
...
### Dispatching Livewire events from Alpine[¶](#dispatching-livewire-events-from-alpine "")
...
## Dispatching a component event to itself[¶](#dispatching-a-component-event-to-itself "")
...
## Testing dispatched events[¶](#testing-dispatched-events "")
...
### Testing Event Listeners[¶](#testing-event-listeners "")
...
## Real-time events using Laravel Echo[¶](#real-time-events-using-laravel-echo "")
...
### Listening for Echo events[¶](#listening-for-echo-events "")
...
### Customizing broadcast event names with `broadcastAs()`[¶](#customizing-broadcast-event-names-with-broadcastas "")
