...
### Creating page components[¶](#creating-page-components "")
...
### How file paths map to component names[¶](#how-file-paths-map-to-component-names "")
...
### Passing route parameters as props[¶](#passing-route-parameters-as-props "")
...
### Passing data from render()[¶](#passing-data-from-render "")
...
### Additional component locations[¶](#additional-component-locations "")
...
#### Registering class-based components[¶](#registering-class-based-components "")
...
### Creating class-based components[¶](#creating-class-based-components "")
...
### When to use class-based components[¶](#when-to-use-class-based-components "")
...
### Configuring default component type[¶](#configuring-default-component-type "")
...
## Customizing component stubs[¶](#customizing-component-stubs "")
...
### Component shows blank or doesn't render[¶](#component-shows-blank-or-doesnt-render "")
...
### Class name conflicts[¶](#class-name-conflicts "")
