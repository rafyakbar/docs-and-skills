[Widgets](/docs/5.x/widgets/overview)
...
- Scatter chart - [Chart.js documentation](https://www.chartjs.org/docs/latest/charts/scatter)For example, you could use a bar chart by returning `'bar'` from the `getType()` method: Here are examples of the other available chart types:
...
[Stats overview widgets](/docs/5.x/widgets/stats-overview)[Panel configuration](/docs/5.x/panel-configuration)
